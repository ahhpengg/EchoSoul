...
- **Current focus:** Track F continues — F3/F4 (home + live sidebar via `list_user_playlists`, photo page webcam + `quick_face_check` wiring), then loading/result/error wiring, then the Web Playback SDK (`playback.js`).
